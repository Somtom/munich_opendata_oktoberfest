...
It looks like both box plots are quiet similar. The median of ZLF years is a sligthly higher.
...
the visitors consume more beer in ZLF years. We are going to take a part of the beer consumption plot
...
follow a similar development. We are going to follow the same procedure as above to test for differences.
