...
In the first part we load and describe the data. Furthermore we analyse the price and consumption of
beer and hendl (chicken) over the years.  

In the second part we are going to have a closer look at the Bavarian Central Agricultural Festival
- also known as "ZLF" - and its influence on beer- and hendl consumption, as well as visitor count. 
...
We are going to use visualizations and simple modeling techniques to describe the data. Further we are
...
The test suggest a true correlation with a Pearson correlation coefficient of 
...
on the data and providing additional resources.
