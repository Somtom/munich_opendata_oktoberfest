...
we will plot the development of price and consumption in one graphic.
...
dt %>% 
  ...
  ggplot() +
  geom_col(aes(x = year, y = visitors_day/1000, fill = zlf), alpha = 0.7) +
...
before the start of the Oktoberfest. Two other big drops can be found in 1988 and 2016.

* Amoklauf in München (2016)
* Eventuell Wetter?
* 

Looking at the ZLF years we can not tell whether the
total visitor count is greater or less in general.   

Let's have a closer look at the total visitor count distribution:
